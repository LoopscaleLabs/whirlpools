import { ZERO, Percentage, MathUtil } from "@orca-so/common-sdk";
...
import { SwapDirection, PriceMath, PoolUtil, TickArrayUtil, TickUtil } from "../utils/public";
 ...
 */
export function depSwapQuoteWithParams(param: SwapQuoteParam): SwapQuote {
  const {
    aToB,
    tokenAmount,
    whirlpoolData,
