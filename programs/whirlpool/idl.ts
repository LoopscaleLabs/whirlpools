  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        {
          name: "whirlpoolsConfig";
          relations: ["whirlpoolsConfigExtension", "tokenBadge"];
        },
        {
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [119, 104, 105, 114, 108, 112, 111, 111, 108];
              },
              {
                kind: "account";
                path: "whirlpoolsConfig";
    ...
    },
    {
      ...
      accounts: [
        {
          name: "whirlpoolsConfig";
          relations: ["whirlpoolsConfigExtension"];
        },
        {
          name: "whirlpoolsConfigExtension";
        },
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [108, 111, 99, 107, 95, 99, 111, 110, 102, 105, 103];
              },
              {
                kind: "account";
                path: "position";
